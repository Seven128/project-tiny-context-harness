...
- Source Plan authoring is an optional upstream helper. It can refine one plan or synthesize a sparse brief plus mixed attachments, accounts for every input, records explicitly delegated low-impact/reversible elaboration and expands interactive scope to surface/region/control/state/feedback detail. The result is ordinary Source guidance, not Context, Contract authority, runtime state or completion proof; high-impact unresolved semantics remain decisions.
