...
- Product/UIUX/development engineer Skill customization uses separate project-local Skills under `<harnessRoot>/skills/<project>_<role>/SKILL.md`; `sync` overwrites package-managed default `context_*` Skills and leaves separate local Skills untouched.
