...
- Standalone design-resource generation remains outside Tiny Context and uses dedicated Product Design, Figma, image-generation, prototype or human workflows. Their outputs enter development as ordinary external Source; candidates never authorize fidelity, and downstream default/Long-Task workflows own durable adoption and evidence.
