...
- Standard frozen Playwright verifier content is trusted without mutation. A weak-observability Outcome requires same-Check sensitivity for every claim-bearing AC and related Claim; designated executed failures normalize to exact mismatch while missing/skipped/partial/other-Check evidence fails closed.
