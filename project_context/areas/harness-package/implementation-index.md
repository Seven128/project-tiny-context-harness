...
- Superpowers-backed composite state kernel behavior: `tests/ty-context/composite-long-task-state.test.mjs`, `tests/ty-context/superpowers-task-compile-strict.test.mjs`, `tests/ty-context/superpowers-task-compile-guards.test.mjs`, `tests/ty-context/superpowers-task-derive.test.mjs`, `tests/ty-context/superpowers-task-validator.test.mjs`, `tests/ty-context/composite-long-task-assertion-gate.test.mjs`, `tests/ty-context/composite-long-task-expanded-assertion-gate.test.mjs`, `tests/ty-context/composite-long-task-completion-output-gate.test.mjs` and `tests/ty-context/composite-long-task-false-completion-regression.test.mjs`.
