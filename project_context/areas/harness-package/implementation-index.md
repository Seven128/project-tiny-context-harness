...
- Mandatory Source marker parsing/inventory/text, exact Risk Fact/Outcome metadata, Non-completing targets and canonical-target continuity: `long-task-source-item-parser.ts`, `long-task-source-inventory.ts`, `long-task-source-target-index.ts`, `long-task-source-target-continuity.ts`, `long-task-source-continuity.ts`, `long-task-source-shape.ts`, `long-task-source-claim-validation.ts`.
