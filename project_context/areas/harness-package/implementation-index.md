...
- Composition and protected authority: `long-task-boundary-check.ts`, `long-task-authority.ts`, `long-task-progress.ts` and `long-task-risk-surfaces.ts`.
- Static compile, generated Claim Coverage, runner identity and risk proof: `long-task-delivery-compiler.ts`, `long-task-claims.ts`, `long-task-claim-definitions.ts`, `long-task-runner-freeze.ts`, `long-task-risk.ts`, `long-task-risk-types.ts`, `long-task-paths.ts`, `long-task-verifier-identity.ts`.
