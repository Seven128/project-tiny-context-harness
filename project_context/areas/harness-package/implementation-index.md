...
- Composition and protected authority: `long-task-boundary-check.ts`, `long-task-authority.ts`, `long-task-authority-revision*.ts`, `long-task-protected-files.ts`, `long-task-progress.ts` and `long-task-risk-surfaces.ts`; canonical Source/Context/Product/Global revision materials, three-way classification, exact external-confirmation change detection and concise material approval summary live in the authority modules.
...
- Scoped progress, precise Source/Claim/AC findings, status/resume/explain/doctor, targeted verification, stateless scope-only candidate exercise, declared-machine terminal scope/no-native-Goal-effect projection and Live Final Gate: `long-task-verifier-v2.ts`, `long-task-authority-revision-diagnosis.ts`, `long-task-progress.ts`, `long-task-status-v2.ts`, `long-task-final-v2.ts`, `long-task-freshness.ts`.
