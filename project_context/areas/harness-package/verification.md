...
- Long-task tests explicitly cover Global and Outcome Claim Coverage, Source/Context/Product/Global semantic Authority Revision identity, fail-closed pattern containment, Bundle normalization, immutable baseline, concrete authority-reduction reasons/risk downgrade, Assertion fail-closed behavior, protected symlink/hardlink inputs, scoped progress, forged Receipt/cache resistance, common-dir binding, Counterfactual/Population/minimal-Environment V2, runner freeze, Live Final Gate and same-group user Hook preservation.
