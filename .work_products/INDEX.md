...
| 产品方案 | `.work_products/01_product/` | PRD slices、用户故事、acceptance criteria、Out of Scope | [npm 包化分发与同步 PRD](01_product/npm_package_distribution.md) |
...
| 测试 | `.work_products/07_test/` | Test cases、test report、test matrix、回归证据、覆盖缺口 | [MVP package release test cases](07_test/TEST_CASES.md), [MVP package release test report](07_test/TEST_REPORT.md), [Harness consumer lab validation](07_test/harness_consumer_lab.md) |
