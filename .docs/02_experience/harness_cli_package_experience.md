...
- Applicability: non_visual_cli
- PRD / Requirement refs: `.docs/01_product/npm_package_distribution.md`; package init/sync/upgrade/validate/release workflow requirements.
- Surface: `sdlc-harness` CLI, generated Makefile gates, generated `AGENTS.md` guidance and `.docs/**` handoff files.
...
| empty | Empty fresh projects still get lifecycle, plan, docs directories and managed files. |
