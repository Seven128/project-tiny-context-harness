...
| RFC | `.docs/rfc/` | 需求变更和影响补丁 | [RFC_001 统一 .harness 工作流根目录](rfc/RFC_001_unify_harness_directory_model.md), [RFC_002 可配置 Harness 根目录](rfc/RFC_002_configurable_harness_root.md) |
