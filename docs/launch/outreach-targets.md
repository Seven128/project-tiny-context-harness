...
- As checked on 2026-07-13, npm `@latest` is 0.2.85 and the latest public GitHub Release is 0.2.57; the prepared 0.4.0 Contract V3 candidate is not launch-ready until its separate audited publication succeeds.
