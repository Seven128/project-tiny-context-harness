...
These packets prepare two curated-list pull requests for AI SDLC Harness. They are intentionally small and factual because both target repositories are maintained resource lists, not launch-post surfaces.
...
git checkout -b add-ai-sdlc-harness
git apply "$PATCH_ROOT/transcenda-awesome-agentic-coding.patch"
git diff --check
git commit -am "Add AI SDLC Harness"
git push -u origin add-ai-sdlc-harness
gh pr create --base main --head Seven128:add-ai-sdlc-harness --title "Add AI SDLC Harness to agent instructions and skills" --body-file /path/to/pr-body.md
```
...
git commit -am "Add AI SDLC Harness"
git push -u origin add-ai-sdlc-harness
gh pr create --base main --head Seven128:add-ai-sdlc-harness --title "Add AI SDLC Harness to team adoption resources" --body-file /path/to/pr-body.md
```
