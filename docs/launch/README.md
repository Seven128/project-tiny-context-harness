...
- Run `npm run launch:npm-access` to inspect npm login, registry reachability and renamed-package existence before retrying publish.
...
- If npm publish is still blocked, invite a small private review group with [reviewer-quickstart.md](reviewer-quickstart.md), [private-review.md](private-review.md) and [private-review-shortlist.md](private-review-shortlist.md) instead of posting broad launch copy.
