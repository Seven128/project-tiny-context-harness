...
| GitHub release | Latest release is `Project Tiny Context Harness 0.7.4` |
| npm package | `project-tiny-context-harness@0.7.4` is published and installable through `@latest` |
