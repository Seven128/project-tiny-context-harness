...
| GitHub release | Latest public release is `Project Tiny Context Harness 0.2.57`; 0.4.0 remains an unpublished release candidate |
| npm package | `project-tiny-context-harness@0.2.85` is installable through `@latest`; 0.4.0 requires a separate publish action |
