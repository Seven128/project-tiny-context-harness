...
- [ADR 001: Stage Contracts and Gates](../../.work_products/05_decisions/ADR_001_stage_contracts_and_gates.md): 阶段契约、阶段 Skill 和交付 gate 是复杂项目降低遗漏与返工的核心控制面。
...
- 内容保持简短，详细说明链接到 `.work_products/` 下的对应文档。
