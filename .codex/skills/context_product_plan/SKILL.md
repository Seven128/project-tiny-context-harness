...
description: Use when the user asks for 产品方案, 产品经理, 需求方案, 需求梳理, 功能方案, 业务规则, 用户故事, 验收标准, MVP, 产品规划, roadmap, user flow, requirements, product spec, PM spec, product plan, product manager, PM, requirements shaping, or product-facing delivery planning in a Minimal Context Harness project. Do not trigger for ordinary coding, bug fixing, package work, or generic mentions of product.
---
...
- 如果用户只是要求实现功能、修 bug、调整代码或处理 package/release，不需要触发本 Skill；只有需要产品判断、需求整理、验收口径或长期产品事实沉淀时才使用。
