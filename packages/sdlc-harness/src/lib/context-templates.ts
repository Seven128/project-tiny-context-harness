export function globalContextTemplate(): string {
  return [
    ...
    "## Design Rationale",
    "",
    "- Record only durable choices that are hard to infer from code or tests. If a change alters product or technical facts, update Context before implementation alignment.",
    "",
