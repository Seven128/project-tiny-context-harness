...
export async function assertSupportedSchema(projectRoot: string, commandName: string): Promise<void> {
...
export function unsupportedSchemaMessage(schemaVersion: string, commandName: string): string | undefined {
