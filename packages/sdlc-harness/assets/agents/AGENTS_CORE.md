...
5. 用户可以在 `.agent/pjsdlc_managed/override_skills/context_product_plan.md` 或 `.agent/pjsdlc_managed/override_skills/context_uiux_design.md` 中追加项目本地 Skill 规则；`sync` 会合并到 `.agent/skills/**`。
