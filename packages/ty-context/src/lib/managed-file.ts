...
export const LEGACY_PJSDLC_MANAGED_BLOCK_START =
  "<!-- pjsdlc:sdlc-harness:begin -->";
export const LEGACY_PJSDLC_MANAGED_BLOCK_END =
...
export const LEGACY_PJSDLC_MAKEFILE_BLOCK_START =
  "# pjsdlc:sdlc-harness:make:begin";
export const LEGACY_PJSDLC_MAKEFILE_BLOCK_END =
...
export const LEGACY_PJSDLC_GITHUB_WORKFLOW_BLOCK_START =
  "# pjsdlc:sdlc-harness:github-workflow:begin";
export const LEGACY_PJSDLC_GITHUB_WORKFLOW_BLOCK_END =
