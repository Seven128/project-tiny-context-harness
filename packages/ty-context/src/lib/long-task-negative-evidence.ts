...
export async function scanLongTaskNegativeEvidence(spec: FrozenVerificationSpecV3, command: CommandRunV2, artifacts: ArtifactManifestV2, artifactRoot: string, evidencePath: string, reverifyCommand: string): Promise<LongTaskFindingV2[]> {
