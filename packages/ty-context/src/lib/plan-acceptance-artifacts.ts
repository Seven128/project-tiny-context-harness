...
function validateRows(rows: Record<string, unknown>[], labelPrefix: string, warnings: string[], hygiene: string[]): void {
...
function validateMilestones(row: Record<string, unknown>, label: string, warnings: string[]): void {
...
function validateStalePartialText(row: Record<string, unknown>, label: string, hygiene: string[]): void {
...
async function findFile(targetDir: string, marker: string, extension: string): Promise<string | undefined> {
...
function warnIfBlank(entry: Record<string, unknown>, label: string, warnings: string[], ...keys: string[]): void {
