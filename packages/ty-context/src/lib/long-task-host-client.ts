...
export interface HostVerifySummaryV1 { schema_version:"ty-context-host-verify-result-v1";contract_sha256:string;run_id:string;workflow_status:"needs_work";findings_count:number;spec_results:Record<string,string> }
export interface HostFinalSummaryV1 { schema_version:"ty-context-host-final-result-summary-v1";contract_sha256:string;run_id:string;workflow_status:"accepted"|"needs_work"|"externally_blocked";findings_count:number;final_result_path:string;external_blocker?:{environment_requirement_ids:string[];reason_codes:string[];minimal_user_action:string} }
