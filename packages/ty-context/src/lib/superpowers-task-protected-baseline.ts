...
export const PROTECTED_BASELINE_PATHS = [
  ...
  "packages/ty-context/src/commands/composite-long-task.ts",
  "packages/ty-context/src/commands/composite-campaign.ts",
  "packages/ty-context/src/lib/plan-acceptance-validator.ts",
  "packages/ty-context/src/lib/superpowers-task-assertion-normalizers.ts",
  ...
  ".codex/ty-context-managed/skills/prepare-composite-long-task/references/scope-fit-and-selection.md",
  ".codex/ty-context-managed/skills/prepare-composite-long-task/references/packet-authoring.md",
  ".codex/ty-context-managed/skills/prepare-composite-long-task/references/campaign-lifecycle.md",
  "packages/ty-context/assets/skills/prepare-composite-long-task/SKILL.md",
  "packages/ty-context/assets/skills/prepare-composite-long-task/references/scope-fit-and-selection.md",
  "packages/ty-context/assets/skills/prepare-composite-long-task/references/packet-authoring.md",
  "packages/ty-context/assets/skills/prepare-composite-long-task/references/campaign-lifecycle.md",
  ".codex/skills/prepare-composite-long-task/SKILL.md",
  ".codex/skills/prepare-composite-long-task/references/scope-fit-and-selection.md",
  ".codex/skills/prepare-composite-long-task/references/packet-authoring.md",
  ".codex/skills/prepare-composite-long-task/references/campaign-lifecycle.md",
