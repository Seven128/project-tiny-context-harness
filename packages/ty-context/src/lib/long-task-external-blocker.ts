...
export function classifyExternalBlocker(run: VerificationRunResultV2, contract: CompiledContractV2): { externally_blocked: boolean; findings: LongTaskFindingV2[]; minimal_user_action?: string } {
