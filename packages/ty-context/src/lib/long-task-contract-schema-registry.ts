...
export const COMPOSITE_V3_SCHEMA_SET_SHA256 = sha256Hex(canonicalJson(COMPOSITE_V3_SCHEMAS));

export function requiredRootFields(schema: keyof typeof COMPOSITE_V3_SCHEMAS): string[] {
