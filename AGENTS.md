...
6. 用户可以在 `.codex/pjsdlc_managed/override_skills/context_product_plan.md`、`.codex/pjsdlc_managed/override_skills/context_uiux_design.md` 或 `.codex/pjsdlc_managed/override_skills/context_development_engineer.md` 中追加项目本地 Skill 规则；`sync` 会合并到 `.codex/skills/**`。
