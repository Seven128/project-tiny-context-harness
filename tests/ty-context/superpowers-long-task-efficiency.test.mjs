...
for (const content of [rootReadme, rootZhReadme, packageReadme, spec, workflowContract]) {
  for (const pattern of [
    ...
    /Final Gate/i,
    /workflow overhead/i,
    /system capability progress|system_capability_progress/i,
    /representative sample progress|representative_sample_progress/i,
    /real object coverage|real_object_coverage/i,
    /full population operation progress|full_population_operation_progress/i,
    /progress ledger/i,
    /artifact budget/i,
