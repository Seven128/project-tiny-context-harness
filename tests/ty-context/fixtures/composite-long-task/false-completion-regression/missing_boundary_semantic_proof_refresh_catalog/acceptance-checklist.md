...
## AC-001: Catalog refresh boundary proof covers the owner surface.

acceptance_scope: system_capability_build
ac_validates:
  - catalog refresh boundary proof
ac_does_not_validate:
  - full population operation
sample_boundary: refresh catalog boundary sample
...
validates_explanation: validates catalog refresh boundary proof
