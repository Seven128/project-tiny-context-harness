...
const sourceExpectations={
  ...
  worktree_changed_during_final:["packages/ty-context/src/lib/long-task-final-orchestrator.ts",/workspace_changed_during_final/],
  worktree_changed_after_final_before_stop:["packages/ty-context/src/lib/long-task-stop-check.ts",/workspace_changed_after_final/],
  compiler_replaced_then_recompiled:[".codex/ty-context-managed/protected-harness-baseline.json",/contract_compiler/],
  final_gate_interrupted_partial_write:["packages/ty-context/src/lib/long-task-durable-json.ts",/rename\(temporary,file\)/],
  final_gate_not_run_agent_says_done:["packages/ty-context/src/lib/long-task-stop-check.ts",/final_result_incomplete/],
  ...
  historical_complete:["packages/ty-context/src/lib/long-task-final-orchestrator.ts",/verifyLongTask\(workdir,contract\.verification_specs/],
  stale_evidence:["packages/ty-context/src/lib/long-task-final-orchestrator.ts",/effectiveRun\.spec_results/],
  ...
  final_card_only:["packages/ty-context/src/lib/long-task-final-orchestrator.ts",/final-result\.json/],
  ...
  current_command_failed_over_older_passed:["packages/ty-context/src/lib/long-task-final-orchestrator.ts",/Object\.values\(projectedRun\.spec_results\)\.every/],
