...
The final implementation must preserve `auditReason`, bulk assignment audit trail behavior, the weighted policy source of truth, and UI/API/test/docs alignment.
