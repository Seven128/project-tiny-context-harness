...
- Context quality: `project_context/**` lets a fresh agent quickly recover project goal, architecture boundary, module boundaries, verification entry points, current state and next safe action.
